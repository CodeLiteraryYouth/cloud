...
public class OAuthController {
    ...
    public Object postAccessToken(
        ...
        switch (client) {
            ...
            default:
                return BaseResult.success(tokenEndpoint.postAccessToken(principal, parameters).getBody());
        }
    }
...
//    public BaseResult wechatLogin(@PathVariable String code, @RequestBody UserInfo userInfo) {

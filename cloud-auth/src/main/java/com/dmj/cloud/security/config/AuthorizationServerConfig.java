...
import com.dmj.cloud.security.service.ClientDetailsServiceImpl;
import com.dmj.cloud.security.service.UserDetailServiceImpl;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public AuthenticationEntryPoint authenticationEntryPoint() {
        return (request, response, e) -> {
            ...
            BaseResult result = BaseResult.fail(ResultStatusCode.CLIENT_AUTHENTICATION_FAILED);
